...
return packer.startup(function(use)
  ...
  -- Core
  --------------------------------------------------------------------------------
  use { "lewis6991/impatient.nvim" }                    -- when you don't want to wait
  -- treesitter
  ...
  -- Look andf Feel
  --------------------------------------------------------------------------------
  use { "goolord/alpha-nvim",                           -- a nvim dashboard
  ...
  use {'akinsho/bufferline.nvim', tag = "v3.*",         -- tabs for buffers
    requires = 'nvim-tree/nvim-web-devicons'}
  use { "moll/vim-bbye" }                               -- close buffers nicely
